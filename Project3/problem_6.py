...
print("Pass" if ((-10, 7) == get_min_max([-10, 2, 0, 5, -3, 7])) else "Fail")
print("Pass" if ((0, 100) == get_min_max([100, 50, 75, 25, 0])) else "Fail")
print("Pass" if ((-15, -1) == get_min_max([-5, -1, -15, -3])) else "Fail")
